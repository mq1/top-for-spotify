<script lang="ts">
	...
	import { avgFeatures } from '$lib/stores/mood';
</script>

{#await $avgFeatures then avgFeatures}
	<Box
		className="flex flex-col gap-y-16 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 font-bold text-white uppercase"
	>
